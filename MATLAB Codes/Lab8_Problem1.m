...
Co = det([y1, y2;subs(y1,n,n+1), subs(y2,n,n+1)]); %Casoratian of the 
solutions
y_c = k1*y1 + k2*y2;
...
if (g ~= 0)
 ...
 y21 = subs(y2,n,n+1);
 Co1 = subs(Co,n,n+1);
 u1 = simplify(symsum(-g*y21/Co1,n))
...
check = input('If the given problem has initial conditions then enter 
1 else enter 0: ');
if (check == 1)
